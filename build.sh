...
log "- To use RVX without root, install [MicroG-RE](https://github.com/WSTxda/MicroG-RE/releases/latest)."
log "- To detach RVX from Play Store, use [zygisk-detach](https://github.com/j-hc/zygisk-detach) module."
log "\nChangelog:"
